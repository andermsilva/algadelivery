package com.algaworks.algdelivery.courier.management.api.controller;

import com.algaworks.algdelivery.courier.management.api.model.CourierInput;
import com.algaworks.algdelivery.courier.management.api.model.CourierPayoutCalculationInput;
import com.algaworks.algdelivery.courier.management.api.model.CourierPayoutResultModel;
...
import com.algaworks.algdelivery.courier.management.domain.service.CourierPayoutService;
import com.algaworks.algdelivery.courier.management.domain.service.CourierRegistrationService;
...
public class CourierController {
    ...
    private final CourierRegistrationService courierRegistration;
    ...
    public Courier create(@Valid @RequestBody CourierInput input) {
        return courierRegistration.create ( input );
    ...
    public Courier update(@PathVariable UUID courierId ,
        ...
        return courierRegistration.update ( courierId,input );
    }
